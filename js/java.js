...
let frutas=[
{id:0,nombre:'Aguacates',precio:2.50,min:0.100,max:5.00},
{id:1,nombre:'Cerezas',precio:3.50,min:0.250,max:3.00 },
{id:2,nombre:'Fresas',precio:1.50,min:0.250,max:2.00 },
{id:3,nombre:'Ciruelas',precio:2.25,min:0.100,max:3.00 },
{id:4,nombre:'Limones',precio:1.10,min:0.100,max:4.00},

{id:5,nombre:'Manzanas',precio:2.35,min:0.100,max:3.00},
{id:6,nombre:'Melocotón',precio:2.15,min:0.100,max:3.00},
{id:7,nombre:'Melón',precio:1.70,min:0.900,max:2.50},
{id:8,nombre:'Platanos',precio:1.55,min:0.100,max:3.50},
{id:9,nombre:'Tomates',precio:1.15,min:0.100,max:3.50},

{id:10,nombre:'Uvas',precio:1.45,min:0.100,max:2.500},
{id:11,nombre:'Ajos',precio:2.75,min:0.050,max:0.800},
{id:12,nombre:'Naranjas',precio:1.70,min:0.100,max:3.00},
{id:13,nombre:'Zanahorias',precio:1.55,min:0.100,max:1.500},
{id:14,nombre:'Peras',precio:1.25,min:0.100,max:3.00}
];
